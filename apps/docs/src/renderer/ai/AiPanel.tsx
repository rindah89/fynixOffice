...
import type { Block } from '@fynixoffice/docx-engine'
import { AgentLoop, composeSkills, type AgentImage } from '@fynixoffice/agent-core'
...
import { Markdown } from '@fynixoffice/ui'
import { AiComposer, AiTypingIndicator } from '@fynixoffice/ui'
