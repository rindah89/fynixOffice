...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiGskLoginBtn: '登录 Fynix AI',
    aiUndelivered: '未送达,本条不会生效',
    aiPanelTitle: 'Fynix AI',
    ...
    aiCreditsExhausted: 'Fynix AI 积分已用完，请前往 genspark.ai/pricing 充值后重试',
  ...
  en: {
    ...
    aiGskLoginBtn: 'Sign in to Fynix AI',
    ...
    aiCreditsExhausted:
      'Your Fynix AI credits have run out. Visit genspark.ai/pricing to top up, then try again',
  ...
  ja: {
    ...
    aiCreditsExhausted:
      'Fynix AIクレジットを使い切りました。genspark.ai/pricing でチャージしてから再試行してください',
  ...
  ko: {
    ...
    aiCreditsExhausted:
      'Fynix AI 크레딧을 모두 사용했습니다. genspark.ai/pricing에서 충전한 후 다시 시도해 주세요',
  ...
  fr: {
    ...
    aiGskLoginBtn: 'Se connecter à Fynix AI',
    ...
    aiCreditsExhausted:
      'Vos crédits Fynix AI sont épuisés. Rechargez sur genspark.ai/pricing puis réessayez',
  ...
  de: {
    ...
    aiGskLoginBtn: 'Bei Fynix AI anmelden',
    ...
    aiRewriteBtn: 'Mit KI umschreiben',
    ...
    aiCreditsExhausted:
      'Deine Fynix AI-Credits sind aufgebraucht. Lade unter genspark.ai/pricing auf und versuche es erneut',
  ...
  es: {
    ...
    aiGskLoginBtn: 'Iniciar sesión en Fynix AI',
    ...
    aiRewriteBtn: 'Reescribir con IA',
    ...
    aiCreditsExhausted:
      'Tus créditos de Fynix AI se han agotado. Recarga en genspark.ai/pricing e inténtalo de nuevo',
  ...
  th: {
    ...
    aiGskLoginBtn: 'ลงชื่อเข้าใช้ Fynix AI',
    ...
    aiCreditsExhausted:
      'เครดิต Fynix AI ของคุณหมดแล้ว โปรดเติมเครดิตที่ genspark.ai/pricing แล้วลองใหม่',
  ...
  id: {
    ...
    aiGskLoginBtn: 'Masuk ke Fynix AI',
    ...
    aiRewriteBtn: 'Tulis ulang dengan AI',
    ...
    aiCreditsExhausted:
      'Kredit Fynix AI Anda telah habis. Isi ulang di genspark.ai/pricing lalu coba lagi',
  ...
  ru: {
    ...
    aiGskLoginBtn: 'Войти в Fynix AI',
    ...
    aiCreditsExhausted:
      'Кредиты Fynix AI исчерпаны. Пополните баланс на genspark.ai/pricing и повторите попытку',
  ...
  ar: {
    ...
    aiGskLoginBtn: 'تسجيل الدخول إلى Fynix AI',
    ...
    aiRewriteBtn: 'إعادة الكتابة بالذكاء الاصطناعي',
    ...
    aiCreditsExhausted:
      'نفدت أرصدة Fynix AI لديك. يرجى إعادة الشحن عبر genspark.ai/pricing ثم المحاولة مجددًا',
  ...
  pt: {
    ...
    aiGskLoginBtn: 'Entrar no Fynix AI',
    ...
    aiRewriteBtn: 'Reescrever com IA',
    ...
    aiCreditsExhausted:
      'Seus créditos Fynix AI acabaram. Recarregue em genspark.ai/pricing e tente novamente',
  ...
  it: {
    ...
    aiGskLoginBtn: 'Accedi a Fynix AI',
    ...
    aiCreditsExhausted:
      'I tuoi crediti Fynix AI sono esauriti. Ricarica su genspark.ai/pricing e riprova',
  ...
  pl: {
    ...
    aiGskLoginBtn: 'Zaloguj się do Fynix AI',
    ...
    aiCreditsExhausted:
      'Twoje kredyty Fynix AI wyczerpały się. Doładuj konto na genspark.ai/pricing i spróbuj ponownie',
  ...
  nl: {
    ...
    aiGskLoginBtn: 'Aanmelden bij Fynix AI',
    ...
    aiRewriteBtn: 'Herschrijven met AI',
    ...
    aiCreditsExhausted:
      'Je Fynix AI-credits zijn op. Waardeer op via genspark.ai/pricing en probeer het opnieuw',
  ...
  ms: {
    ...
    aiGskLoginBtn: 'Log masuk ke Fynix AI',
    ...
    aiRewriteBtn: 'Tulis semula dengan AI',
    ...
    aiCreditsExhausted:
      'Kredit Fynix AI anda telah habis. Tambah nilai di genspark.ai/pricing dan cuba lagi',
    aiSumReadAttachment: 'Baca lampiran',
  ...
  he: {
    ...
    aiGskLoginBtn: 'התחבר ל-Fynix AI',
    ...
    aiCreditsExhausted: 'קרדיטי Fynix AI שלך אזלו. טען מחדש ב-genspark.ai/pricing ונסה שוב',
  ...
  hi: {
    ...
    aiGskLoginBtn: 'Fynix AI में साइन इन करें',
    ...
    aiCreditsExhausted:
      'आपके Fynix AI क्रेडिट समाप्त हो गए हैं। genspark.ai/pricing पर रिचार्ज करें और फिर से प्रयास करें',
  ...
  'zh-TW': {
    ...
    aiCreditsExhausted: 'Fynix AI 點數已用完，請前往 genspark.ai/pricing 儲值後重試',
