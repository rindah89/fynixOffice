...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@fynixoffice/pptx-render'
...
function ShowMediaLayer({
  ...
  const nodes = slide.nodes.filter(
    (n): n is import('@fynixoffice/pptx-render').PictureRenderNode =>
      n.type === 'picture' && !!(n as import('@fynixoffice/pptx-render').PictureRenderNode).media,
  )
