...
import { addPicture, createBlankPptx, openPptx, savePptx } from '@fynixoffice/pptx-engine'
import { buildRenderSlide, type PictureRenderNode } from '@fynixoffice/pptx-render'
import {
  decodeInkPayload,
  encodeInkPayload,
  inkNodeHitTest,
